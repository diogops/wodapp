...
export const EXERCISE_CATALOG: CatalogExercise[] = [
  ...
  // Agachamentos e pernas
  { name: "Air Squat", category: "Agachamentos e pernas" },
  { name: "Back Squat", category: "Agachamentos e pernas" },
  { name: "Front Squat", category: "Agachamentos e pernas" },
  { name: "Goblet Squat", category: "Agachamentos e pernas" },
  { name: "Wall Ball", category: "Agachamentos e pernas" },
  { name: "Lunge", category: "Agachamentos e pernas" },
  { name: "Walking Lunge", category: "Agachamentos e pernas" },
  { name: "Box Step-up", category: "Agachamentos e pernas" },
  { name: "Pistol", category: "Agachamentos e pernas" },

  // Levantamento e força
  { name: "Deadlift", category: "Levantamento e força" },
  { name: "Sumo Deadlift High Pull", category: "Levantamento e força" },
  { name: "Bench Press", category: "Levantamento e força" },
  { name: "Strict Press", category: "Levantamento e força" },
  { name: "Push Press", category: "Levantamento e força" },
  { name: "Kettlebell Swing", category: "Levantamento e força" },
  { name: "Turkish Get-up", category: "Levantamento e força" },
  { name: "Farmer Carry", category: "Levantamento e força" },
  { name: "Bent Over Row", category: "Levantamento e força" },
